...
- _Gestor Pokémon_: O desafio de um mestre Pokémon também é o desafio de gerir bem sua equipe, por isso podemos pensar em utilizarmos ferramentas de BI para gerarmos informações úteis a partir de um conjunto de dados. E então poderemos utilizarmos estas informações em nossa tomada de decisões.
